    ...
    <div class="container mx-auto  mt-6">
        ...
        @if ($monsters->count() > 0)
            @foreach ($monsters as $monster)
                <div class="bg-gray-700 mt-6 rounded-lg shadow-lg monster-card" data-monster-type="{{ $monster->type->name }}">
                    <div class="md:flex">
                        <!-- Image du monstre -->
                        <div class="w-full md:w-1/2 relative">
                            ...
                            <div class="absolute top-4 right-4">
                                <form action="{{ route('monsters.favorite', ['monsterId' => $monster->id]) }}"
                                    method="POST">
                                    @csrf
                                    <button type="submit"
