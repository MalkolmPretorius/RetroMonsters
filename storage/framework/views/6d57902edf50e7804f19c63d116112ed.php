    ...
    <div class="container mx-auto  mt-6">
        ...
        <?php if($monsters->count() > 0): ?>
            <?php $__currentLoopData = $monsters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $monster): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-gray-700 mt-6 rounded-lg shadow-lg monster-card" data-monster-type="<?php echo e($monster->type->name); ?>">
                    <div class="md:flex">
                        <!-- Image du monstre -->
                        <div class="w-full md:w-1/2 relative">
                            ...
                            <div class="absolute top-4 right-4">
                                <form action="<?php echo e(route('monsters.favorite', ['monsterId' => $monster->id])); ?>"
                                    method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
...
<?php echo $__env->make('templates.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Makil\Dropbox\mamp\htdocs\framework_serveur\RetroMonsters\resources\views/search/results.blade.php ENDPATH**/ ?>