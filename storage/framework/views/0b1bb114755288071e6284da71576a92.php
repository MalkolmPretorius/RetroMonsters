...
<?php endif; ?>
        ...
        <div class="flex items-center space-x-4 justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                <a class="underline text-sm text-white hover:text-red-500 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" href="<?php echo e(route('password.request')); ?>">
            ...
            <?php if(Route::has('register')): ?>
                <a class="underline text-sm text-white hover:text-red-500 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" href="<?php echo e(route('register')); ?>">
...
<?php endif; ?>
<?php /**PATH C:\Users\Makil\Dropbox\mamp\htdocs\framework_serveur\RetroMonsters\resources\views/auth/login.blade.php ENDPATH**/ ?>