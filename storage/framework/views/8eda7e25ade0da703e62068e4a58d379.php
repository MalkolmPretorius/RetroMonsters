 ...
 <aside class="w-full md:w-1/4 p-4">
     ...
     <form action="<?php echo e(route('search.text')); ?>" method="GET" class="bg-gray-700 rounded-lg shadow-lg p-4 mb-6">
     ...
     <form action="<?php echo e(route('search.criteria')); ?>" method="GET" class="bg-gray-700 rounded-lg shadow-lg p-4">
...
<?php /**PATH C:\Users\Makil\Dropbox\mamp\htdocs\framework_serveur\RetroMonsters\resources\views/templates/partials/_aside.blade.php ENDPATH**/ ?>